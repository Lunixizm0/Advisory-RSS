...
# src/advisory_rss/__init__.py
sed -i "s/^__version__ = .*/__version__ = \"${VERSION}\"/" src/advisory_rss/__init__.py
...
git add src/advisory_rss/__init__.py
...
echo "https://github.com/Lunixizm0/Advisory-RSS/actions"
echo "https://pypi.org/project/advisory-rss/${VERSION}/"

echo ""
echo "PyPI üzerinde ${VERSION} versiyonu bekleniyor..."

PYPI_URL="https://pypi.org/pypi/advisory-rss/${VERSION}/json"
MAX_ATTEMPTS=30
SLEEP_SECONDS=5
